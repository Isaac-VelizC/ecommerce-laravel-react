                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 gap-y-4">
                    <div className="w-full">
                        <div className="pl-[65px] relative">
                            <i className="fa fa-car text-accent text-[36px] absolute left-0 top-[4px]"></i>
                    ...
                    <div className="w-full">
                        <div className="pl-[65px] relative">
                            <i className="fa fa-money-bill-1 text-accent text-[36px] absolute left-0 top-[4px]"></i>
                    ...
                    <div className="w-full">
                        <div className="pl-[65px] relative">
                            <i className="fa fa-life-ring text-accent text-[36px] absolute left-0 top-[4px]"></i>
                    ...
                    <div className="w-full">
                        <div className="pl-[65px] relative">
                            <i className="fa fa-headphones text-accent text-[36px] absolute left-0 top-[4px]"></i>
